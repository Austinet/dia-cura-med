    ...
    <section className="">
      {/* <div className="container mx-auto w-[85%]">
                <div className="lg:flex lg:flex-row flex flex-col-reverse lg:pt-[90px] lg:gap-[220px] lg:mb-[90px] mb-[40px] pt-6">
                    ...
                    <div>
                        <h3 className="lg:text-[20px] lg:mt-0 mt-3 font-Open-sans font-extrabold text-[14px] " data-aos="fade-left"></h3>
                        <h3 className="lg:w-[512px] lg:h-[108px] lg:leading-[50px]  leading-10 lg:text-[40px] text-[32px] lg:mt-4 mt-4 font-extrabold text-[#062D45]  font-Open-sans " data-aos="fade-left"></h3>
                        ...
                        <Link to="/get-started">
                            <button className=" lg:flex lg:text-[20px]  hover:bg-[#9353e5] font-bold  lg:justify-center lg:px-3 pt-4 hidden lg:w-[179px] lg:h-[56px] text-[#FFFFFF] bg-[#107BC0] lg:mt-[120px] rounded-md"></button></Link>
      ...
      <div>
        ...
        <h1>Get Expert Medical Help With Diabetes From Us</h1>
        <p>
          Discover personalized solutions, expert guidance, and a supportive
